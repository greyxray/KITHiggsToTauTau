...
#      "trg_doubletau_20_vbf_jets:HLT_VBF_DoubleLooseChargedIsoPFTau20_Trk1_eta2p1_Reg_v",
  ...
  config["SingleTauTriggerWeightWorkspaceWeightNames"] = [
          ...
          "0:SingleTauDataEfficiencyWeightGenuineTauZprimeOrSUSYH_TightMVA",
          "1:SingleTauDataEfficiencyWeightGenuineTauZprimeOrSUSYH_TightMVA",
          "0:SingleTauDataEfficiencyWeightGenuineTauZprimeOrSUSYH_TightMVA_upShift",
          "1:SingleTauDataEfficiencyWeightGenuineTauZprimeOrSUSYH_TightMVA_upShift",
          "0:SingleTauDataEfficiencyWeightGenuineTauZprimeOrSUSYH_TightMVA_downShift",
          "1:SingleTauDataEfficiencyWeightGenuineTauZprimeOrSUSYH_TightMVA_downShift",
          ]
  config["SingleTauTriggerWeightWorkspaceObjectNames"] = [
          ...
          "0:t_trgsingletau_genuinetau_zprimesusyh_mc",
          "1:t_trgsingletau_genuinetau_zprimesusyh_mc",
          "0:t_trgsingletau_genuinetau_zprimesusyh_data",
          "1:t_trgsingletau_genuinetau_zprimesusyh_data",
          "0:t_trgsingletau_genuinetau_zprimesusyh_data_upShift",
          "1:t_trgsingletau_genuinetau_zprimesusyh_data_upShift",
          "0:t_trgsingletau_genuinetau_zprimesusyh_data_downShift",
          "1:t_trgsingletau_genuinetau_zprimesusyh_data_downShift",
          ]
  ...
  if isEmbedded:
    ...
    config["Quantities"].extend([
        ...
        "SingleTauDataEfficiencyWeightGenuineTauZprimeOrSUSYH_TightMVA_1", "SingleTauDataEfficiencyWeightGenuineTauZprimeOrSUSYH_TightMVA_2",
        "SingleTauDataEfficiencyWeightGenuineTauZprimeOrSUSYH_TightMVA_upShift_1", "SingleTauDataEfficiencyWeightGenuineTauZprimeOrSUSYH_TightMVA_upShift_2",
        "SingleTauDataEfficiencyWeightGenuineTauZprimeOrSUSYH_TightMVA_downShift_1", "SingleTauDataEfficiencyWeightGenuineTauZprimeOrSUSYH_TightMVA_downShift_2",
    ])
  elif not isData:
  ...
  config["Quantities"].extend(["trg_doubletau_20_vbf", "trg_doubletau_20_vbf_jets", "trg_doubletau_20_vbf_vbfjets", "trkpt_1", "trkpt_2"])
